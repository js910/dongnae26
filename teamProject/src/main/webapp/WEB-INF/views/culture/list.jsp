	        ...
	        $.ajax({
	            ...
	            success: function(data) {
	                ...
	                if(data && Array.isArray(data.list)) {
	                	...
	                	console.error('데이터 형식이 올바르지 안ㄶ므: ', data);
	                }
	            },
			...
			<form id="searchForm" action="/culture/list" method="get">
				<div class="col-lg-6">
					<select class="form-select form-control">
						...
						<option value="titlec" ${pageMaker.cri.type == "titlec" ? "selected":"" }>행사 제목</option>
						<option value="placec" ${pageMaker.cri.type == "placec" ? "selected":"" }>장소</option>
					</select>
				</div>
				<div>
		           	<input type="search" class="col-4 form-control" name="keyword" value="${pageMaker.cri.keyword }">
