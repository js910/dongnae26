                        ...
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="/resources/images/slide/volunteer-helping-with-donation-box.jpg"
                                ...
                                <div class="carousel-item">
                                    <img src="/resources/images/slide/volunteer-selecting-organizing-clothes-donations-charity.jpg"
                                        class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="/resources/images/slide/medium-shot-people-collecting-donations.jpg"
                                        class="carousel-image img-fluid" alt="...">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="/resources/images/icons/hands.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="/resources/images/icons/heart.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="/resources/images/icons/receive.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="/resources/images/icons/scholarship.png" class="featured-block-image img-fluid" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        <img src="/resources/images/group-people-volunteering-foodbank-poor-people.jpg"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <img src="/resources/images/portrait-volunteer-who-organized-donations-charity.jpg"
                            ...
                            <div class="carousel-inner">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="0" class="active">
                                        <img src="/resources/images/avatar/portrait-beautiful-young-woman-standing-grey-wall.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>

                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="1" class="">
                                        <img src="/resources/images/avatar/portrait-young-redhead-bearded-male.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>

                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="2" class="">
                                        <img src="/resources/images/avatar/pretty-blonde-woman-wearing-white-t-shirt.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>

                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="3" class="">
                                        <img src="/resources/images/avatar/studio-portrait-emotional-happy-funny.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>
                                </ol>
